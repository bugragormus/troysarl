...
import { LayoutDashboard, Car, Receipt, Users, Settings, LogOut, ChevronLeft, ChevronRight, Menu, PenTool, LineChart } from "lucide-react";
...
export default function AdminLayout({ children, activeTab, setActiveTab, handleLogout }: AdminLayoutProps) {
  ...
  const menuItems = [
    ...
    { id: "insights", label: "Lead Insights", icon: LineChart },
