                    ...
                    <div className="flex justify-between h-16 items-center">
                        ...
                        <div className="flex-shrink-0 flex items-center">
                            <Link href="/" className="flex items-center space-x-2">
                                <Image
                                    src="/troysarl_logo.jpeg"
                                    alt="Troysarl Logo"
                                    width={60}
                                    height={60}
                                    className="rounded-full"
                                />
                                <span className="text-2xl font-bold text-blue-600">Troy Cars S.A.R.L.</span>
                            </Link>
                        </div>
                        ...
                        <div className="hidden md:flex space-x-8">
                            <Link
                                href="/"
                                className={`${isActive('/') ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-600'} px-1 py-2 text-sm font-medium hover:text-blue-600`}
                            >
                                Ana Sayfa
                            </Link>
                            <Link
                                href="/admin"
                                className={`${isActive('/admin') ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-600'} px-1 py-2 text-sm font-medium hover:text-blue-600`}
                            >
                                Admin
                            </Link>
                            <Link
                                href="/contact"
                                className={`${isActive('/contact') ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-600'} px-1 py-2 text-sm font-medium hover:text-blue-600`}
                            >
                                İletişim
                            </Link>
                        </div>
